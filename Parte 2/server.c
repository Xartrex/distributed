...
void tratar_peticion (int *s) {
	...
	if(0 == strcmp(inputBuff,"REGISTER")){
        ...
        int conclusion;
        retvalRPC = registeruser_1(user, &conclusion, client);
        if(retvalRPC != RPC_SUCCESS) {
            clnt_perror(client, "callfailed:");
        }
        ...
        int conclusion;
        retvalRPC = connectuser_1(user, s_local, inputBuff, &conclusion, client);
        if(retvalRPC != RPC_SUCCESS) {
            clnt_perror(client, "callfailed:");
        }
        ...
        int conclusion;
        retvalRPC = unregisteruser_1(user, &conclusion, client);
        if(retvalRPC != RPC_SUCCESS) {
            clnt_perror(client, "callfailed:");
        }
        ...
        int conclusion;
        retvalRPC = disconnectuser_1(user, &conclusion, client);
        if(retvalRPC != RPC_SUCCESS) {
            clnt_perror(client, "callfailed:");
        }
        ...
        int conclusion;
        retvalRPC = publishfile_1(inputBuff, name, usery, &conclusion, client);
        if(retvalRPC != RPC_SUCCESS) {
            clnt_perror(client, "callfailed:");
        }
        ...
        int conclusion;
        retvalRPC = deletefile_1(name, usery, &conclusion, client);
        if(retvalRPC != RPC_SUCCESS) {
            clnt_perror(client, "callfailed:");
        }
